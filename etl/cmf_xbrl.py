...
class ManifestStore:
    ...
    def __init__(self, path: Path) -> None:
        ...
        # Multiple shard workers may ingest different issuers concurrently.
        # WAL plus a generous busy timeout lets writers serialize safely while
        # keeping the manifest idempotent.
...
class CmfXbrlClient:
    ...
    def get(self, url: str) -> httpx.Response:
        # Respect the CMF public endpoint and avoid hammering a reused socket
        # after the origin closes it. This also makes shard retries gentler.
        time.sleep(0.25)
    ...
    try:
        if args.all_issuers:
            ...
            if args.shard_count > 1:
                issuers = [
                    issuer for index, issuer in enumerate(issuers)
