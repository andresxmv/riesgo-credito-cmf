        ...
        <div className="page-content">
          ...
          <section className="section-block">
            ...
            <div className="metrics-grid">
              ...
              <MetricCell label="Net debt / EBITDA" value={ratioValue("netDebtEbitda")} detail={ratioDetail("netDebtEbitda")} tone="blue" />
              <MetricCell label="Interest coverage" value={ratioValue("interestCoverage")} detail={ratioDetail("interestCoverage")} tone="mint" />
              <MetricCell label="Current ratio" value={ratioValue("currentRatio")} detail={ratioDetail("currentRatio")} />
              <MetricCell label="ROIC" value={ratioValue("roic")} detail={ratioDetail("roic")} tone="violet" />
              <MetricCell label="FCF" value={ratioValue("fcf")} detail={ratioDetail("fcf")} tone="gold" />
              <MetricCell label="Deuda / activos" value={ratioValue("debtAssets")} detail={ratioDetail("debtAssets")} tone="blue" />
              <MetricCell label="Quick ratio" value={ratioValue("quickRatio")} detail={ratioDetail("quickRatio")} />
              <MetricCell label="Cash ratio" value={ratioValue("cashRatio")} detail={ratioDetail("cashRatio")} tone="mint" />
            </div>
          </section>
          ...
          <div className="main-grid">
            ...
            <aside className="panel memo-panel">
              ...
              <div className="memo-lede">{issuerData.hasXbrl ? "El read model CMF XBRL está disponible para este emisor. La opinión crediticia y el score interno se mostrarán cuando se ejecute el modelo versionado; no se sustituyen con estimaciones." : "No hay una opinión crediticia calculable para este emisor porque todavía no existen estados financieros XBRL validados en la capa de datos."}</div>
